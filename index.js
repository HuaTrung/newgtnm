...
rate:"4.1",option:["Sci-Fi","Thriller","Drama"],class:"movie movie--test movie--test--dark movie--test--left"},
  ...
  rate:"5.0",option:["Adventure"," Fantasy "," Drama"],class:"movie movie--test movie--test--dark movie--test--left"},
  ...
  rate:"4.5",option:["Sci-Fi","Thriller","Drama"],class:"movie movie--test movie--test--dark movie--test--right"},
  {id: 4, title: 'Thor: The Dark World (2013)',time:"91 min",imagePath:"http://image.phimmoi.net/film/255/poster.medium.jpg",
rate:"5.0",option:["Action", "Adventure" , "Fantasy"],class:"movie movie--test movie--test--dark movie--test--right"},
...
rate:"4.7",option:["Action", "Adventure" , "Horoor"],class:"movie movie--test movie--test--dark movie--test--left"},
...
rate:"4.8",option:["Crime" , "Thriller" , "Drama"],class:"movie movie--test movie--test--dark movie--test--left"},
...
rate:"5.0",option:["Comedy", "Adventure" , "Fantasy"],class:"movie movie--test movie--test--dark movie--test--right"},
...
rate:"4.5",option:["Action", "Adventure" , "Fantasy"],class:"movie movie--test movie--test--dark movie--test--right"}];
